...
import com.bage.mapper.statistics.SqlInfoStatisticsMapper;
import com.bage.utils.TimeUtils;


@Service
public class SqlInfoStatisticsService {

	@Autowired
	private SqlInfoStatisticsMapper sqlInfoStatisticsMapper;

	public List<Map<String, Object>> queryLatest(String appid ,String maxId ){
		return sqlInfoStatisticsMapper.queryLatest(appid,maxId);
	}
	public int insertBatchMinute(List<SqlInfoStatistics> list){
		return sqlInfoStatisticsMapper.insertBatchMinute(list);
	}
	
	public int insertBatchHour(List<SqlInfoStatistics> list){
		return sqlInfoStatisticsMapper.insertBatchHour(list);
	}
	
	public int insertBatchDay(List<SqlInfoStatistics> list){
		return sqlInfoStatisticsMapper.insertBatchDay(list);
	}
	
	public int insertBatchMonth(List<SqlInfoStatistics> list){
		return sqlInfoStatisticsMapper.insertBatchMonth(list);
	}
	
	public int insertBatchYear(List<SqlInfoStatistics> list){
		return sqlInfoStatisticsMapper.insertBatchYear(list);
	}
	...
	public List<Map<String, Object>> topN(int n, String startTime, String stopTime, String sortType,
		...
		if ("".equals(startTime) || "".equals(stopTime)) {
			...
			if (ConfigConstraints.MEMORYDURATIONTYPE_LATESTHOUR.equals(durationType)) {
				...
				return sqlInfoStatisticsMapper.topNHour(n, sortType, startTime, stopTime);
				...
				return sqlInfoStatisticsMapper.topNDay(n, sortType, startTime, stopTime);
				...
				return sqlInfoStatisticsMapper.topNMonth(n, sortType, startTime, stopTime);
				...
				return sqlInfoStatisticsMapper.topNYear(n, sortType, startTime, stopTime);
			}
		} else {
			// 自定义时间查询
			...
			if (dis[0] >= 365) { // 应该查询年统计表
				...
				//return sqlInfoStatisticsMapper.topNMinute(n, sortType, startTime, stopTime);
			}
		}
		// 默认 最近一小时
		stopTime = TimeUtils.getCurrentTime();
	...
	public List<Map<String, Object>> latest(String appid, int n){
		...
		return sqlInfoStatisticsMapper.latest(appid, n,startTime, stopTime);
	}
	

	// 查询分表
	private int getMinuteTotalRow(String appid, String condition, String startTime, String stopTime) {
		return sqlInfoStatisticsMapper.getMinuteTotalRow(appid, condition, startTime, stopTime);
	}
	...
	private int getHourTotalRow(String appid, String condition, String startTime, String stopTime) {
		return sqlInfoStatisticsMapper.getHourTotalRow(appid, condition, startTime, stopTime);
	}
	...
	private int getDayTotalRow(String appid, String condition, String startTime, String stopTime) {
		return sqlInfoStatisticsMapper.getDayTotalRow(appid, condition, startTime, stopTime);
	}
	...
	private int getMonthTotalRow(String appid, String condition, String startTime, String stopTime) {
		return sqlInfoStatisticsMapper.getMonthTotalRow(appid, condition, startTime, stopTime);
	}
	...
	private int getYearTotalRow(String appid, String condition, String startTime, String stopTime) {
		return sqlInfoStatisticsMapper.getYearTotalRow(appid, condition, startTime, stopTime);
	}
	...
	public List<Map<String, Object>> queryByPage(String appid, int tagPage, int pageLength, String condition,
		...
		// 先判断是否是自定义时间
		if (!"".equals(timeDuration) && ("".equals(startTime) || "".equals(stopTime))) {
			startTime = "";
			stopTime = "";
			if (ConfigConstraints.TIMEDURATION_MINUTE.equals(timeDuration)) {
				// 查询分时间表
				...
				return sqlInfoStatisticsMapper.queryMinuteByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
				...
				int startId = pageLength * (tagPage - 1);
				return sqlInfoStatisticsMapper.queryHourByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
				...
				int startId = pageLength * (tagPage - 1);
				return sqlInfoStatisticsMapper.queryDayByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
				...
				int startId = pageLength * (tagPage - 1);
				return sqlInfoStatisticsMapper.queryMonthByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
				...
				int startId = pageLength * (tagPage - 1);
				return sqlInfoStatisticsMapper.queryYearByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
			...
			// 自定义时间查询，直接去查询分数据表
			if (!TimeUtils.isDateTimeFormat(startTime)){
				startTime = "";
			}
			if (!TimeUtils.isDateTimeFormat(stopTime)){
				stopTime = "";
			}
			int totalRow = getMinuteTotalRow(appid, condition, startTime, stopTime);
			int totalPage = totalRow / pageLength;
