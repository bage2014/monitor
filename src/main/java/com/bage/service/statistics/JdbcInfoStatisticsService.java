...
import com.bage.mapper.statistics.JdbcInfoStatisticsMapper;
import com.bage.utils.TimeUtils;

@Service
public class JdbcInfoStatisticsService {

	@Autowired
	private JdbcInfoStatisticsMapper jdbcInfoStatisticsMapper;

	public List<Map<String, Object>> queryLatest(String appid ,String maxId ){
		return jdbcInfoStatisticsMapper.queryLatest(appid,maxId);
	}
	
	public int insertBatchMinute(List<JdbcInfoStatistics> list) {
		return jdbcInfoStatisticsMapper.insertBatchMinute(list);
	}

	public int insertBatchHour(List<JdbcInfoStatistics> list) {
		return jdbcInfoStatisticsMapper.insertBatchHour(list);
	}

	public int insertBatchDay(List<JdbcInfoStatistics> list) {
		return jdbcInfoStatisticsMapper.insertBatchDay(list);
	}

	public int insertBatchMonth(List<JdbcInfoStatistics> list) {
		return jdbcInfoStatisticsMapper.insertBatchMonth(list);
	}

	public int insertBatchYear(List<JdbcInfoStatistics> list) {
		return jdbcInfoStatisticsMapper.insertBatchYear(list);
	}
	...
	public List<Map<String, Object>> topN(int n, String startTime, String stopTime, String sortType,
		...
		if ("".equals(startTime) || "".equals(stopTime)) {
			...
			if (ConfigConstraints.MEMORYDURATIONTYPE_LATESTHOUR.equals(durationType)) {
				...
				return jdbcInfoStatisticsMapper.topNHour(n, sortType, startTime, stopTime);
				...
				return jdbcInfoStatisticsMapper.topNDay(n, sortType, startTime, stopTime);
				...
				return jdbcInfoStatisticsMapper.topNMonth(n, sortType, startTime, stopTime);
				...
				return jdbcInfoStatisticsMapper.topNYear(n, sortType, startTime, stopTime);
			}
		} else {
			// 自定义时间查询
			...
			if (dis[0] >= 365) { // 应该查询年统计表
				...
				//return jdbcInfoStatisticsMapper.topNMinute(n, sortType, startTime, stopTime);
			}
		}
		// 默认 最近一小时
		stopTime = TimeUtils.getCurrentTime();
	...
	public List<Map<String, Object>> latest(String appid, int n){
		...
		return jdbcInfoStatisticsMapper.latest(appid, n,startTime, stopTime);
	}
	...
	private int getMinuteTotalRow(String appid, String condition, String startTime, String stopTime) {
		return jdbcInfoStatisticsMapper.getMinuteTotalRow(appid, condition, startTime, stopTime);
	}
	...
	private int getHourTotalRow(String appid, String condition, String startTime, String stopTime) {
		return jdbcInfoStatisticsMapper.getHourTotalRow(appid, condition, startTime, stopTime);
	}
	...
	private int getDayTotalRow(String appid, String condition, String startTime, String stopTime) {
		return jdbcInfoStatisticsMapper.getDayTotalRow(appid, condition, startTime, stopTime);
	}
	...
	private int getMonthTotalRow(String appid, String condition, String startTime, String stopTime) {
		return jdbcInfoStatisticsMapper.getMonthTotalRow(appid, condition, startTime, stopTime);
	}
	...
	private int getYearTotalRow(String appid, String condition, String startTime, String stopTime) {
		return jdbcInfoStatisticsMapper.getYearTotalRow(appid, condition, startTime, stopTime);
	}
	...
	public List<Map<String, Object>> queryByPage(String appid, int tagPage, int pageLength, String condition,
		...
		if ("".equals(startTime) || "".equals(stopTime)) {
			if (ConfigConstraints.TIMEDURATION_MINUTE.equals(timeDuration)) {
				...
				return jdbcInfoStatisticsMapper.queryMinuteByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
				...
				int startId = pageLength * (tagPage - 1);
				return jdbcInfoStatisticsMapper.queryHourByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
				...
				int startId = pageLength * (tagPage - 1);
				return jdbcInfoStatisticsMapper.queryDayByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
				...
				int startId = pageLength * (tagPage - 1);
				return jdbcInfoStatisticsMapper.queryMonthByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
				...
				int startId = pageLength * (tagPage - 1);
				return jdbcInfoStatisticsMapper.queryYearByPage(appid, startId, pageLength, condition, startTime,
						stopTime);
