...
/**
 * Http请求统计信息对象(年月日时分)(秒不做额外存储)
 * 
 * @author bage
 *
 */
public class HttpInfoStatistics implements Serializable {
	...
	public HttpInfoStatistics() {
		super();
	}

	public HttpInfoStatistics(int id, int appid, String queryTime, String name, String iid, float hits,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HttpInfoStatistics other = (HttpInfoStatistics) obj;
		if (id != other.id)
			return false;
		return true;
	}
