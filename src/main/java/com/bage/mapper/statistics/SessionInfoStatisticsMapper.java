...
@Mapper
public interface SessionInfoStatisticsMapper {

	int insertBatchMinute(List<SessionInfoStatistics> list);
	int insertBatchHour(List<SessionInfoStatistics> list);
	int insertBatchDay(List<SessionInfoStatistics> list);
	int insertBatchMonth(List<SessionInfoStatistics> list);
	int insertBatchYear(List<SessionInfoStatistics> list);
	...
	Map<String, Object> latestOne(@Param("appid") String appid);
